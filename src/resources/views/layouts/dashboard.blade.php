    ...
    <aside class="w-72 bg-white/80 border-r border-slate-200 flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 text-sm font-medium">
            ...
            <a href="{{ route('dashboard') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl {{ request()->routeIs('dashboard') ? $active : $inactive }}">
                Dashboard
            </a>
    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="h-16 bg-white/70 backdrop-blur-xl border-b border-slate-200 px-6 flex items-center justify-between">
            ...
            <div class="relative group">
                ...
                <div
                    class="absolute right-0 mt-3 w-52 bg-white rounded-2xl shadow-xl border border-slate-200
                           opacity-0 invisible group-focus-within:visible group-focus-within:opacity-100
                           transition-all duration-200"
                >
                    <a href="#"
                       class="block px-4 py-3 text-sm hover:bg-slate-100 rounded-t-2xl">
                        Meu perfil
                    </a>
