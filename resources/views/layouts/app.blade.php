    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-[#201E1E] text-white border-r shadow-sm flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('musica.index') }}"
                    class="flex items-center gap-2 px-3 py-2 rounded border-l-4 border-transparent hover:border-[#201E1E] {{ request()->routeIs('musica.*') ? 'bg-white text-[#201E1E] border-[#201E1E]' : 'text-white' }}">
